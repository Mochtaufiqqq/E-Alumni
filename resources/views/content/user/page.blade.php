                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                            ...
                            <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                                <div class="card-body d-flex align-items-center">
                                    <div class="bg-primary shadow-primary rounded-3 flex-shrink-0 p-3">
                                        <img src="{{ asset('user/img/about/icons/headset-light.svg') }}" class="d-block m-1" width="40"
                                            alt="Icon">
                                    </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                                <div class="card-body d-flex align-items-center">
                                    <div class="bg-primary shadow-primary rounded-3 flex-shrink-0 p-3">
                                        <img src="{{ asset('user/img/about/icons/chat-light.svg" c') }}lass="d-block m-1" width="40"
                                            alt="Icon">
                                    </div>
                                    <div class="ps-4 ms-lg-3">
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                                <div class="card-body d-flex align-items-center">
                                    <div class="bg-primary shadow-primary rounded-3 flex-shrink-0 p-3">
                                        <img src="{{ asset('user/img/about/icons/add-group-light.sv') }}g" class="d-block m-1" width="40"
                                            alt="Icon">
                                    </div>
                                    <div class="ps-4 ms-lg-3">
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                                <div class="card-body d-flex align-items-center">
                                    <div class="bg-primary shadow-primary rounded-3 flex-shrink-0 p-3">
                                        <img src="{{ asset('user/img/about/icons/location-light.svg') }}" class="d-block m-1" width="40"
                                            alt="Icon">
                                    </div>
                                    <div class="ps-4 ms-lg-3">
