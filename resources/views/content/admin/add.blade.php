                ...
                @csrf
                  <div class="mb-3 m-form__group">
                    ...
                    <div class="input-group">
                      <input class="form-control @error('nisn') is-invalid @enderror" type="text" name="nisn" placeholder="NISN" required autofocus>
                    </div>
                    @error('nisn')
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      <input class="form-control @error('nama') is-invalid @enderror" type="text" name="nama" placeholder="Nama Lengkap" aria-label="Recipient's username" required autofocus>
                    </div>
                    @error('nama')
                    <div class="invalid-feedback">
                        {{ $message }}
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      <input class="form-control @error('email') is-invalid @enderror" name="email" type="email" aria-label="Amount (to the nearest dollar)" placeholder="Email" required autofocus>
                    </div>
                    @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                  ...
                  <div class="mb-3">
                    ...
                    <div class="input-group">
                      <input class="form-control @error('alamat') is-invalid @enderror" name="alamat" type="text" aria-label="Amount (to the nearest dollar)" placeholder="Alamat" required autofocus>
                    </div>
                    @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
